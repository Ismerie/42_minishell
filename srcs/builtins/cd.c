...
/* change the value of PWD and OLDPWD */
...
/* run the changement of directory */
...
/* check if we use "-" and check if we can move to the path */
...
/* check if we use "~" for HOME and get the value */
...
/* fonction launched if command[0] = "cd" */
